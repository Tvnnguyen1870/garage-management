          ...
          >
            <Row gutter={24}>
              <Col className="gutter-row" span={8}>
                ...
                >
                  <br />
                  <Input style={{ right: '175px', marginTop: '20px' }} defaultValue={'2222'} />
                </Form.Item>
              </Col>
              ...
              <Col className="gutter-row" span={8}>
                ...
                >
                  <br />
                  <Input style={{ right: '150px', marginTop: '20px' }} defaultValue={'2222'} />
                </Form.Item>
              </Col>
              ...
              <Col className="gutter-row" span={8}>
                ...
                >
                  <br />
                  <Input.Password style={{ right: '170px', marginTop: '20px' }} defaultValue={'2222'} />
                </Form.Item>
              </Col>
              ...
              <Col className="gutter-row" span={8}>
                ...
                >
                  <br />
                  <Input style={{ right: '205px', marginTop: '20px' }} defaultValue={'2222'} />
                </Form.Item>
              </Col>
              ...
              <Col className="gutter-row" span={8}>
                ...
                >
                  ...
                  <Select
                    ...
                    style={{ right: '160px', marginTop: '20px' }}
                    defaultValue={'2222'}
                  >
              ...
              <Col className="gutter-row" span={8}>
                <Form.Item name="dob" label="DOB" {...config}>
                  <br />
                  <DatePicker style={{ right: '140px', marginTop: '20px' }} defaultValue={'2222'} />
                </Form.Item>
              </Col>
              ...
              <Col className="gutter-row" span={8}>
                ...
                >
                  ...
                  <Select
                    placeholder="select your gender"
                    style={{ right: '140px', marginTop: '20px' }}
                    defaultValue={'2222'}
                  >
