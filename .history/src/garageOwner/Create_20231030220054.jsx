        ...
        >
          <Row gutter={24}>
            ...
            <Col className="gutter-row" span={12}>
              ...
              >
                <br />
                <Input.Password style={{ right: '213px', marginTop: '20px' }} />
              </Form.Item>
            </Col>
            ...
            <Col className="gutter-row" span={12}>
              ...
              >
                <br />
                <Select placeholder="select your gender" style={{ right: '213px', marginTop: '20px' }}>
            ...
            <Col className="gutter-row" span={12}>
              <Form.Item name="dob" label="DOB" {...config}>
                <br />
                <DatePicker style={{ right: '213px', marginTop: '20px' }} />
              </Form.Item>
            </Col>
